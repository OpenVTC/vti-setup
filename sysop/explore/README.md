...
> The box runs everything as root, leaves SSH wide open to the operator, and has no per-service isolation. For a hardened production deployment, see the [Deploy stream](../deploy/) (hardened Kubernetes — not yet documented).
