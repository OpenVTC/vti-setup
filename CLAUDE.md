...
- **Offline VTA setup** — the VTA is unreachable at setup time (air-gapped, or just bootstrapping). Mediator and WebVH import pre-generated sealed bundles. This is the flow `sysop/explore/02-walkthrough.md` describes.
