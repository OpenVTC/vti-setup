...
You run the VTI infrastructure: VTA, DIDComm Mediator, and WebVH Daemon. [Developers](../developer/) and [community managers](../community-manager/) sit on top of what you set up.
...
| [AWS EC2 / VPS](aws-ec2.md) | Cloud-hosted VM. _(Not yet written.)_ |
...
Both use the **offline sealed-bundle bootstrap** flow over DIDComm — the same flow you'd use to set up a VTI where the VTA is air-gapped from Mediator and WebVH, even when they happen to share a host.
...
- [Self-Managed WebVH Host](self-managed-webvh.md) _(stub)_
